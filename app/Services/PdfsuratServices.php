...
class PdfsuratServices
{
    ...
    public function PDFTidakMampu($data)
    {
        ...
        $this->fpdf->setWidths(array(10, 5, 50, 5, 120));
        ...
        $this->fpdf->NoBaris(array('', 'c.', 'Tempat/Tanggal Lahir', ':', $data['ortu_tempat'] . "/" . $data['ortu_tanggal']));
        ...
        $this->fpdf->setWidths(array(10, 5, 50, 5, 120));
        $this->fpdf->NoBaris(array('', 'a.', 'Nama', ':', $data['kepala']));
        $this->fpdf->NoBaris(array('', 'b.', 'NIK', ':', $data['jabatan']));
        $this->fpdf->NoBaris(array('', 'c.', 'Tempat/Tanggal Lahir', ':', $data['jabatan']));
        $this->fpdf->NoBaris(array('', 'd.', 'Jenis Kelamin', ':', $data['jabatan']));
        $this->fpdf->NoBaris(array('', 'e.', 'Status', ':', $data['jabatan']));
        $this->fpdf->NoBaris(array('', 'f.', 'Pekerjaan', ':', $data['jabatan']));
        $this->fpdf->NoBaris(array('', 'g.', 'Alamat', ':', $data['jabatan']));
