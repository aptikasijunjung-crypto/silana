<form id="proses" onsubmit="return false;">
    @csrf
    <input type="hidden" name="layanan_id" id="layanan_id" value="2">
    ...
    <div class="form-group">
        ...
        <input type="text" name="pejabat_name" id="pejabat_name" class="form-control form-control-solid"
    ...
    <div class="form-group">
        ...
        <input type="text" name="jabatan" id="jabatan" class="form-control form-control-solid"
            placeholder="Jabatan" value="{{ $data->jabatan }}" readonly>
    </div>
    <div class="form-group">
        <label for="">NIK</label>
        <input type="text" name="pejabat_nik" id="pejabat_nik" class="form-control form-control-solid"
            placeholder="NIK" value="{{ $data->nik }}" readonly>
    </div>
    ...
    <div class="form-group row">
        <label class="col-form-label col-lg-3 col-sm-12">Jenis Usaha</label>
        <div class="col-lg-9 col-md-9 col-sm-12">
            <input id="kt_tagify_1" class="form-control tagify" name='tags' placeholder='type...'
                value='Petani Karet, Petani Sawit, Peternak Sapi' autofocus="" data-blacklist='.NET,PHP' />
            <div class="mt-3">
                <a href="javascript:;" id="kt_tagify_1_remove"
                    class="btn btn-sm btn-light-primary font-weight-bold">Remove Jenis</a>
            </div>
...
<script>
    ...
    $("form#proses").submit(function() {
        $.LoadingOverlay('show');
        $.post("{{ route('keterangan.usaha.store') }}", $(this).serialize(), function(data) {
            if (data.id == 0) {
