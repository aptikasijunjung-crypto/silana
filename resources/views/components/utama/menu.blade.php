                        ...
                        <h1 class="header-logo">
                            <a href="index.html">
                                <img alt="Porto" width="100" height="48"
                                    src="{{ 'frontend/' }}img/logo-default-slim.png">
                    ...
                    <div class="header-row h-100">
                        <a href="http://themeforest.net/item/porto-responsive-html5-template/4106987" target="_blank"
                            ...
                            <img alt="Porto" class="img-fluid ps-3"
                                src="{{ 'frontend/' }}img/blog/blog-ad-2.jpg" />
                        </a>
                    </div>
                </div>
            </div>
                                                ...
                                                <ul class="nav nav-pills" id="mainNav">
                                                    ...
                                                    <li class="dropdown dropdown-full-color dropdown-light">
                                                        ...
                                                        <ul class="dropdown-menu">
                                                            ...
                                                            <li>
                                                                <a class="dropdown-item"
                                                                    href="feature-style-switcher.html">Style
                                                                    Switcher <span class="tip tip-dark">hot</span></a>
                                                            </li>
                                                            <li class="dropdown-submenu">
                                                    ...
                                                    <li class="dropdown dropdown-full-color dropdown-light">
                                                        ...
                                                        <ul class="dropdown-menu">
                                                            ...
                                                            <li class="dropdown-submenu">
                                                                ...
                                                                <ul class="dropdown-menu">
                                                                    <li><a class="dropdown-item"
                                                                            href="about-us-advanced.html">About
                                                                            Us - Advanced</a></li>
                                                                    <li><a class="dropdown-item"
                                                            ...
                                                            <li><a class="dropdown-item" href="page-login.html">Login
                                                                    ...
                                                                    Register</a></li>
                                                            <li><a class="dropdown-item"
                                                                    href="page-user-profile.html">User
                                                                    Profile</a></li>
                                                        </ul>
                                                    </li>
                                                    <li class="dropdown dropdown-full-color dropdown-light">
