...
Dribbble: www.dribbble.com/keenxfthemes
...
<body id="kt_body"
            ...
            <div class="d-flex flex-column flex-row-fluid wrapper" id="kt_wrapper">
                ...
                <div id="kt_header" class="header header-fixed">
                    ...
                    <div class="container-fluid d-flex align-items-stretch justify-content-between">
                        ...
                        <x-backend.menuatas></x-backend.menuatas>
                        ...
                        <div class="topbar">
                            ...
                            <div class="topbar-item">
                                <div class="btn btn-icon btn-icon-mobile w-auto btn-clean d-flex align-items-center btn-lg px-2"
                                    ...
                                    <span
                                        class="text-dark-50 font-weight-bolder font-size-base d-none d-md-inline mr-3">{{ $profilData->name }}</span>
                ...
                <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
                        ...
                        <div
                            ...
                            <div class="d-flex align-items-center flex-wrap mr-2">
                                ...
                                <a href="{{ route('documents') }}"
                                    class="btn btn-light-warning font-weight-bolder btn-sm mr-3">Add
                                    New</a>
                                <a href="{{ route('notifikasi') }}"
                                    class="btn btn-light-success font-weight-bolder btn-sm mr-4">Notifikasi</a>
                                <a href="{{ route('notifikasi_') }}"
                                    class="btn btn-light-info font-weight-bolder btn-sm">TTE Layanan</a>
                                <!--end::Actions-->
                            </div>
                            <!--end::Info-->
                            <!--begin::Toolbar-->
                    ...
                    <div class="d-flex flex-column-fluid">
                        <!--begin::Container-->
                        <div class="container" id="konten-app">
                            @yield('konten')
                        </div>
                        <!--end::Container-->
                    </div>
                ...
                <div class="d-flex flex-column">
                    ...
                    <div class="navi mt-2">
                        ...
                        <form action="{{ route('profile.logout') }}" method="POST">
                            @csrf
                            <button type="submit"
                                class="btn btn-sm btn-light-primary font-weight-bolder py-2 px-5">Sign Out</button>
                        </form>
    ...
    <script src="{{ asset('assets/js/proses.js') }}"></script>
    <script src="{{ asset('assets/js/sa.js') }}"></script>
