                        ...
                        <ul class="nav nav-tabs nav-tabs-space-lg nav-tabs-line nav-bold nav-tabs-line-3x" role="tablist">
                            ...
                            <li class="nav-item mr-3">
                                <a class="nav-link active" data-toggle="tab" href="#kt_apps_contacts_view_tab_2">
                                    ...
                                    <span class="nav-text">Profil Organisasi</span>
                                </a>
                            </li>
                            <li class="nav-item mr-3">
                ...
                <div class="card-body px-0">
                    <div class="tab-content pt-5">
                                    ...
                                    <div class="timeline-items">
                                        <div class="timeline-item">
                                            ...
                                            <div class="timeline-content">
                                                ...
                                                <p class="p-0">Sed ut perspiciatis unde omnis iste natus error sit
                                        ...
                                        <div class="timeline-item">
                                            ...
                                            <div class="timeline-content">
                                                <div class="d-flex align-items-center justify-content-between mb-3">
                                                    <div class="mr-2">
                                                        <a href="#"
                                                            class="text-dark-75 text-hover-primary font-weight-bold">Member
                                                            has sent a request.</a>
                                        ...
                                        <div class="timeline-item">
                                            ...
                                            <div class="timeline-content">
                                                <div class="d-flex align-items-center justify-content-between mb-3">
                                                    <div class="mr-2">
                                                        <a href="#"
                                                            class="text-dark-75 text-hover-primary font-weight-bold">System
                                                            deployment has been completed.</a>
                                        ...
                                        <div class="timeline-item">
                                            ...
                                            <div class="timeline-content">
                                                <div class="d-flex align-items-center justify-content-between mb-3">
                                                    <div class="mr-2">
                                                        <a href="#"
                                                            class="text-dark-75 text-hover-primary font-weight-bold">Database
                                                            backup has been completed.</a>
                        ...
                        <div class="tab-pane active" id="kt_apps_contacts_view_tab_2" role="tabpanel">
                            <form class="form" action="{{ route('profil.update') }}" method="post"
                                ...
                                <div class="row">
                                    <div class="col-lg-9 col-xl-6 offset-xl-3">
                                        <h3 class="font-size-h6 mb-5">Main Info:</h3>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-xl-3 col-lg-3 col-form-label text-right">Nama Desa/Nagari</label>
                                    <div class="col-lg-9 col-xl-6">
                                        <input class="form-control form-control-lg form-control-solid" type="text"
                                            value="{{ $data->kelurahan_name }}" readonly>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9 col-xl-6">
                                        <input class="form-control form-control-lg form-control-solid" type="text"
                                            value="{{ strtoupper($data->kecamatan_name) }}" readonly>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-xl-3 col-lg-3 col-form-label text-right">Kab/Kota</label>
                                    <div class="col-lg-9 col-xl-6">
                                        <input class="form-control form-control-lg form-control-solid" type="text"
                                            value="{{ $data->kota_name }}" readonly>
                                    ...
                                    <div class="col-lg-9 col-xl-6">
                                        <div class="input-group input-group-lg input-group-solid">
                                            ...
                                            <input type="text" class="form-control form-control-lg form-control-solid"
                                                name="website" value="{{ $data->website }}" placeholder="Website">
                                        </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9 col-xl-6">
                                        <div class="input-group input-group-lg input-group-solid">
                                            ...
                                            <input type="text" class="form-control form-control-lg form-control-solid"
                                                name="alamat" value="{{ $data->alamat }}" placeholder="Email">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-9 col-xl-6 offset-xl-3">
                                        <h3 class="font-size-h6 mb-5">Pejabat Info:</h3>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-xl-3 col-lg-3 col-form-label text-right">Nama Kepala</label>
                                    <div class="col-lg-9 col-xl-6">
                                        <div class="input-group input-group-lg input-group-solid">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text">
                                            ...
                                            <input type="text" class="form-control form-control-lg form-control-solid"
                                                name="kepala" id="kepala" value="{{ $data->kepala }}"
                                                placeholder="Nama Kepala">
                                            <input type="hidden" name="kepalaid" id="kepalaid"
                                                value="{{ $data->kepalaid }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9 col-xl-6">
                                        ...
                                        <span class="form-text text-muted">Anda dapat merubah jabatan sesuai dengan
                                            sebutan pimpinan instansi anda</span>
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="row">
                                    <div class="col-lg-9 col-xl-6 offset-xl-3">
                                        <h3 class="font-size-h6 mb-5">Image Info:</h3>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9 col-xl-6">
                                        <div class="custom-file">
                                            <input type="file" class="custom-file-input" id="file-logo">
                                            <label class="custom-file-label" for="customFile">Choose file</label>
                                        </div>
                                        <span class="form-text text-muted">Atur Lebar logo 100px dengan tinggi 48px dengan
                                            format
                                            PNG</span>
                                        <div class="sampel-banner">
                                            <img alt="Porto" id="showLogo" class="img-fluid ps-3"
                                                src="{{ empty($data->logo) ? asset('frontend/img/logo-default-slim.png') : $data->logo }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-xl-3 col-lg-3 col-form-label text-right">Banner</label>
                                    <div class="col-lg-9 col-xl-6">
                                        <div class="custom-file">
                                            <input type="file" class="custom-file-input" id="file-banner"
                                                accept="png" name="banner">
                                            <label class="custom-file-label" for="customFile">Choose file</label>
                                        </div>
                                        <span class="form-text text-muted">Sistem akan mengkonfersi ukuran file secara
                                            otomatis</span>
                                        <div class="sampel-banner">
                                            <img alt="showBanner" id="showBanner" class="img-fluid ps-3"
                                                {{-- src="http://127.0.0.1:8000/frontend/img/blog/blog-ad-2.jpg"> --}}
                                                src="{{ empty($data->banner) ? 'http://127.0.0.1:8000/frontend/img/blog/blog-ad-2.jpg' : $data->banner }}">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9 col-xl-6">
                                        <select class="form-control form-control-lg form-control-solid">
                                            ...
                                            <option data-offset="39600" value="New Caledonia">(GMT+11:00) New Caledonia
                                            </option>
    ...
    <script>
        ...
        $('input#kepala').autocomplete({
            ...
            select: function(event, ui) {
                $("input#kepala").val(ui.item.label);
                $("input#nik").val(ui.item.nik);
                $("input#jabatan").val(ui.item.jabatan);
                $("input#kepalaid").val(ui.item.value);
